...
const { registerUser, loginUser, getUserDetails, updateUserDetails, logoutUser, deleteUser, getUsers, addShippingDetails, getShippingdetails, getUserRole, checkShippingDetails, updateShippingDetails, countUsers, sendVerificationEmail, updatePassword, userFeedback, fetchFeedback } = require('../controller/userController')
...
router.route('/deleteUser/:id').delete(userAuth, deleteUser)
